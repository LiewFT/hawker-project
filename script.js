...
const I18N = {
  ...
  privacyRetentionText: { en: "Your account and reviews are kept until you delete them. While signed in, you can delete a review from its venue page, or your whole account (which also deletes all your reviews) from the Account page.", zh: "你的账户和评价会保留到你自行删除为止。登录后，你可以在小贩中心页面删除单条评价，或在账户页面删除整个账户（同时删除你的所有评价）。" },
