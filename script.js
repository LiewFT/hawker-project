...
const I18N = {
  ...
  aboutReaderReviewsText: { en: "Visitors can leave a star rating and a short note on a hawker centre's page. You need an account (an email address and a nickname). Visitor reviews are written by visitors, are not checked by our team before they appear, and are kept separate from our own reviews.", zh: "访客可以在小贩中心页面留下星级评分和简短留言，需要注册账户（电子邮箱和昵称）。访客评价由访客撰写，发布前未经本团队审核，并与我们自己的评价分开显示。" },
  ...
  // --- visitor reviews and accounts (venue.html) ---
  reviewsTitle: { en: 'Visitor reviews', zh: '访客评价' },
  reviewsOff: { en: 'Visitor reviews are not switched on yet.', zh: '访客评价功能尚未开启。' },
  reviewsLoading: { en: 'Loading…', zh: '加载中……' },
  reviewsLoadError: { en: "Couldn't load reviews. Please try again later.", zh: '无法加载评价，请稍后再试。' },
  reviewsNone: { en: 'No reviews yet. Be the first.', zh: '暂无评价，来写第一条吧。' },
  reviewsSummary: { en: '{avg} / 5 · {n} visitor reviews', zh: '{avg} / 5 · {n} 条访客评价' },
  reviewsSummaryOne: { en: '{avg} / 5 · 1 visitor review', zh: '{avg} / 5 · 1 条访客评价' },
  reviewsNote: { en: 'Written by visitors with an account, not by our team, and not checked before they appear.', zh: '由注册访客撰写，并非本团队所写，发布前未经审核。' },
  reviewWrite: { en: 'Write a review', zh: '写评价' },
  reviewYours: { en: 'Your review', zh: '你的评价' },
  reviewRatingLabel: { en: 'Your rating', zh: '你的评分' },
  reviewStarsOption: { en: '{n} out of 5', zh: '{n} 分（满分 5 分）' },
  reviewTextLabel: { en: 'Your review (optional, up to 1000 characters)', zh: '你的评价（选填，最多 1000 字）' },
  reviewPost: { en: 'Post review', zh: '发布评价' },
  reviewUpdate: { en: 'Update review', zh: '更新评价' },
  reviewDelete: { en: 'Delete my review', zh: '删除我的评价' },
  reviewDeleteConfirm: { en: 'Delete your review?', zh: '要删除你的评价吗？' },
  reviewPosted: { en: 'Thanks, your review is posted.', zh: '谢谢，你的评价已发布。' },
  reviewRemoved: { en: 'Your review was deleted.', zh: '你的评价已删除。' },
  reviewNeedRating: { en: 'Please choose a star rating.', zh: '请选择星级评分。' },
  authPrompt: { en: 'Sign in or create an account to review this hawker centre.', zh: '登录或注册账户后，即可评价这个小贩中心。' },
  authSignIn: { en: 'Sign in', zh: '登录' },
  authRegister: { en: 'Create account', zh: '注册账户' },
  authNickname: { en: 'Nickname (shown publicly with your reviews)', zh: '昵称（会与你的评价一起公开显示）' },
  authEmail: { en: 'Email (never shown publicly)', zh: '电子邮箱（不会公开显示）' },
  authPassword: { en: 'Password', zh: '密码' },
  authPasswordHint: { en: 'At least 8 characters.', zh: '至少 8 个字符。' },
  authConsentBefore: { en: 'I agree to the', zh: '我同意' },
  authConsentAfter: { en: ', and to my nickname being shown with my reviews.', zh: '，并同意我的昵称与评价一起公开显示。' },
  authForgot: { en: 'Forgot password?', zh: '忘记密码？' },
  authResetSend: { en: 'Send reset email', zh: '发送重置邮件' },
  authResetSent: { en: 'If that email has an account, a reset link is on its way.', zh: '如果该邮箱已注册，重置链接已发送。' },
  authVerifyNeeded: { en: 'We sent a verification link to {email}. Verify your email to post reviews.', zh: '我们已向 {email} 发送验证链接。验证邮箱后才能发表评价。' },
  authVerifySent: { en: 'Verification email sent. Check your inbox (and spam folder).', zh: '验证邮件已发送，请查看收件箱（及垃圾邮件文件夹）。' },
  authVerifiedBtn: { en: "I've verified my email", zh: '我已验证邮箱' },
  authNotYetVerified: { en: 'Not verified yet. Open the link in the email, then try again.', zh: '尚未验证。请先打开邮件中的链接，再试一次。' },
  authResend: { en: 'Resend email', zh: '重新发送邮件' },
  authSignedInAs: { en: 'Signed in as {name}', zh: '已登录：{name}' },
  authSignOut: { en: 'Sign out', zh: '退出登录' },
  authDelete: { en: 'Delete my account and reviews', zh: '删除我的账户和评价' },
  authDeleteHelp: { en: 'This permanently deletes your account, your email address and all your reviews. Enter your password to confirm.', zh: '这将永久删除你的账户、电子邮箱和所有评价。请输入密码确认。' },
  authDeleteConfirmBtn: { en: 'Delete permanently', zh: '永久删除' },
  authDeleted: { en: 'Your account and reviews were deleted.', zh: '你的账户和评价已删除。' },
  errNickname: { en: 'Nickname must be 2 to 30 characters.', zh: '昵称需为 2 至 30 个字符。' },
  errConsent: { en: 'Please tick the box to continue.', zh: '请勾选同意后再继续。' },
  errEmailInUse: { en: 'That email is already registered. Try signing in.', zh: '该邮箱已注册，请直接登录。' },
  errBadLogin: { en: 'Wrong email or password.', zh: '邮箱或密码不正确。' },
  errWeakPassword: { en: 'Choose a stronger password (at least 8 characters).', zh: '请设置更强的密码（至少 8 个字符）。' },
  errInvalidEmail: { en: "That email address doesn't look right.", zh: '这个邮箱地址似乎不正确。' },
  errTooMany: { en: 'Too many attempts. Please wait a few minutes and try again.', zh: '尝试次数过多，请等几分钟后再试。' },
  errNetwork: { en: 'Network problem. Check your connection and try again.', zh: '网络出错，请检查连接后再试。' },
  errPermission: { en: 'This was not accepted. Make sure your email is verified, then try again.', zh: '操作未被接受。请确认已验证邮箱，然后再试。' },
  errGeneric: { en: 'Something went wrong. Please try again.', zh: '出了点问题，请再试一次。' },
  ...
  privacyCollectNote: { en: "Browsing the site needs no account. This is what we collect if you create an account to leave a review.", zh: "浏览本网站无需账户。以下是你注册账户并发表评价时，我们会收集的信息。" },
  privacyCollect1: { en: "Your email address and a nickname you choose. Your password is never stored by us; the sign-in service keeps only a hash of it.", zh: "你的电子邮箱和你选择的昵称。我们不会保存你的密码；登录服务只保存密码的哈希值。" },
  privacyCollect2: { en: "The reviews you post (a star rating and optional text), shown publicly with your nickname and the date. Your email address is never shown.", zh: "你发布的评价（星级评分和可选文字），会连同你的昵称和日期公开显示。你的电子邮箱不会公开。" },
  privacyCollect3: { en: "We do not run analytics or advertising trackers on this site.", zh: "本网站不使用分析工具或广告追踪器。" },
  ...
  privacyProtectTitle: { en: "How your data is protected", zh: "我们如何保护你的数据" },
  privacyProtectText: { en: "Data travels over HTTPS and is stored encrypted at rest by Google. Passwords are hashed by the sign-in service and never visible to us. Your email address is kept only in the sign-in service, not in the public reviews database. This is provider-side encryption, not end-to-end encryption: the service provider can technically access what it stores.", zh: "数据通过 HTTPS 传输，并由 Google 加密存储。密码由登录服务做哈希处理，我们无法看到。你的电子邮箱只保存在登录服务中，不会进入公开的评价数据库。这是服务商端的加密，而非端到端加密：服务商在技术上可以访问其所存储的数据。" },
  ...
  privacyRetentionText: { en: "Your account and reviews are kept until you delete them. While signed in, you can delete a review, or your whole account (which also deletes all your reviews), from any venue page.", zh: "你的账户和评价会保留到你自行删除为止。登录后，你可以在任何小贩中心页面删除单条评价，或删除整个账户（同时删除你的所有评价）。" },
  privacyThirdPartyTitle: { en: 'Third-party services', zh: '第三方服务' },
  privacyThirdPartyText: { en: "Sign-in and reviews are handled by Google Firebase (Authentication and Cloud Firestore). Map tiles come from OneMap (SLA). The site is hosted on GitHub Pages. Each has its own privacy policy.", zh: "登录和评价由 Google Firebase（Authentication 与 Cloud Firestore）处理。地图图块来自 OneMap（SLA）。网站托管于 GitHub Pages。它们各有自己的隐私政策。" },
